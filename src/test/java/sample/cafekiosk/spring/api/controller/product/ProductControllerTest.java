...
@ActiveProfiles("test")
@WebMvcTest(controllers = ProductController.class) // Controller 관련 bean만 띄우는 어노테이션
class ProductControllerTest {
    ...
    @MockBean // Container 에 Mock 객체를 넣어줌
    ...
    void createProduct() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.status().isOk()); // API를 쏘는 수행
    }
    ...
    @Test
    void createProductSelling() throws Exception {
        //given
        ProductCreateRequest request = ProductCreateRequest.builder()
                .type(ProductType.HANDMADE)
                .name("아메리카노")
    ...
    @Test
    void createProductNotPositivePrice() throws Exception {
        //given
    ...
    @Test
    void createProductName() throws Exception {
        //given
        ProductCreateRequest request = ProductCreateRequest.builder()
                .type(ProductType.HANDMADE)
                .sellingStatus(ProductSellingStatus.SELLING)
